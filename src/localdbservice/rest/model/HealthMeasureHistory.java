...
public class HealthMeasureHistory implements Serializable {
	...
	public static HealthMeasureHistory getValueMeasureHistory(Integer idPerson, Integer idMeasureDef, Integer idMeasureHistory){
		...
		Query query=em.createQuery("SELECT h FROM HealthMeasureHistory h WHERE h.idMeasureHistory=:idMeasureHistory AND h.idMeasureDef=:idMeasureDef AND h.idPerson=:idPerson", LifeStatus.class);
